...
const Dashboard = () => {
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      const val = (r: unknown) => r.status === "fulfilled" ? r.value : null;
  ...
  const activeTeachers = teachers.filter((t: unknown) => t.isActive !== false).length;
